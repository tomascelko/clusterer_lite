...
class node_args
{
  ...
  void check_existence_file(const std::string &node_name, const std::string &arg_name) const;
...
template <>
inline int node_args::get_arg<int>(const std::string &node_name, const std::string &arg_name) const
{
...
template <>
inline double node_args::get_arg<double>(const std::string &node_name, const std::string &arg_name) const
{
  return std::stod(args_data_.at(node_name).at(arg_name));
};
// parse string argument
template <>
inline std::string node_args::get_arg<std::string>(const std::string &node_name, const std::string &arg_name) const
{
...
template <>
inline bool node_args::get_arg<bool>(const std::string &node_name, const std::string &arg_name) const
{
