...
template <typename data_type, typename stream_type> class data_printer
{
...
public:
  ...
  std::string name() { return "printer"; }

  void process_single_data(data_type &&data) { (*out_stream_) << data; }
