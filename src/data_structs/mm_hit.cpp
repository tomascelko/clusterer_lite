...
mm_hit::mm_hit(short x, short y, double toa, double e) : coord_(x, y),
                                                         toa_(toa),
                                                         e_(e)
{
}
...
const coord &mm_hit::coordinates() const
{
  return coord_;
}
short mm_hit::x() const
{
  return coord_.x_;
}
short mm_hit::y() const
{
  return coord_.y_;
}
double mm_hit::time() const
{
  return toa();
}
double mm_hit::toa() const
{
  return toa_;
}
double mm_hit::e() const
{
  return e_;
}
