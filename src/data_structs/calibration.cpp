...
void calibration::load_calib_vector(std::string &&name, const coord &chip_size, std::vector<std::vector<double>> &vector)
{
...
calibration::calibration(const std::string &calib_folder, const coord &chip_size)
{
