...
void node_args::check_existence_file(const std::string &node_name,
...
node_args::at(const std::string &node_name) const
{
...
node_args::operator[](const std::string &node_name)
{
