...
burda_hit::burda_hit(uint16_t linear_coord, int64_t toa, short fast_toa, int16_t tot) : linear_coord_(linear_coord),
                                                                                        toa_(toa),
                                                                                        fast_toa_(fast_toa),
                                                                                        tot_(tot) {}
...
bool burda_hit::is_valid()
{
  return toa_ >= 0;
}
uint16_t burda_hit::linear_coord() const
{
  return linear_coord_;
}

uint64_t burda_hit::tick_toa() const
{
  return toa_;
}
...
short burda_hit::fast_toa() const
{
  return fast_toa_;
}
int16_t burda_hit::tot() const
{
  return tot_;
}
uint32_t burda_hit::size() const
{
  return avg_size();
}
